...
import com.example.kustim_v01.HealthRegisterActivity;
...
public class PopupActivity5 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.popup_activity5);
...
//    }
    ...
    public void mOnClose(View v) {
        ...
        if (v.getId() == R.id.promise_accept5) {
            Intent intent = new Intent(this, HealthRegisterActivity.class);
            startActivity(intent);
        }
        //데이터 전달하기
        if (v.getId() == R.id.promise_refuse5) {
